    ...
    <footer className="border-t border-white/50 bg-stone-950 text-stone-100">
      <div className="mx-auto grid w-[min(1200px,calc(100%-1.5rem))] gap-10 py-14 lg:grid-cols-[1.5fr_1fr_1fr]">
        <div>
          ...
          <h2 className="mt-3 [font-family:var(--font-cormorant)] text-4xl font-semibold text-white">A marketplace-style jewelry storefront with a boutique soul.</h2>
        <p className="mt-4 max-w-xl text-sm leading-7 text-stone-300">{siteConfig.description} Customers can browse, filter, review products, add items to cart, and complete online-only payments through Razorpay.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="mt-4 space-y-3 text-sm text-stone-200">
            ...
            <p>Custom domain ready on Vercel from day one.</p>
          </div>
        </div>
      </div>
    </footer>
