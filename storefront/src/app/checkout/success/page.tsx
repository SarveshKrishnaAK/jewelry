    ...
    <div className="pb-20 pt-16 lg:pb-28">
      <div className="mx-auto w-[min(900px,calc(100%-1.5rem))]">
        <section className="rounded-[40px] border border-white/70 bg-white/85 p-8 text-center shadow-[0_24px_70px_rgba(87,60,14,0.1)] lg:p-12">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-stone-600">Your payment has been verified against Razorpay and the storefront has marked the checkout as complete. The webhook route is also ready for asynchronous reconciliation, confirmation emails, and future order persistence.</p>
