    ...
    <div className="pb-20 pt-16 lg:pb-28">
      <div className="mx-auto w-[min(900px,calc(100%-1.5rem))]">
        <section className="rounded-[40px] border border-white/70 bg-white/85 p-8 text-center shadow-[0_24px_70px_rgba(87,60,14,0.1)] lg:p-12">
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-stone-500">Payment canceled</p>
          <h1 className="mt-4 [font-family:var(--font-cormorant)] text-5xl font-semibold text-stone-900">Your cart is still waiting for you.</h1>
          <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-stone-600">Nothing was charged. You can return to checkout, edit the cart, or continue browsing before trying again.</p>
