...
import { AccountFlashUrlCleaner } from '@/components/account-flash-url-cleaner';
...
export default async function AccountPage({ searchParams }: AccountPageProps) {
  ...
  if (session?.role === 'user' && user) {
    return (
      <>
        <AccountFlashUrlCleaner email={emailHint ?? undefined} mode={mode || undefined} nextPath={next} shouldClean={shouldCleanFlash} />
